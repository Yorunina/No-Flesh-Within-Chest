StartupEvents.registry('item', event => {
    ...
    registeOrgan(new Organ('kubejs:long_lasting_pill_gold')
        ...
        .addTextLines('alt', [LEADING_SYMBOL, Text.gray('在关闭器官时会自动触发激活效果')])
        .build())
        .modelJson(modelOverlay('kubejs:item/organs/others/long_lasting_pill', GOLD_OVERLAY))
        .tag('kubejs:evolution');
    ...
    // 基本器官
    registeOrgan(new Organ('kubejs:muscle_iron').addScore('strength', 1.25).addScore('speed', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/muscle', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:muscle')
    registeOrgan(new Organ('kubejs:spleen_iron').addScore('metabolism', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/spleen', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:spleen')
    registeOrgan(new Organ('kubejs:appendix_iron').addScore('luck', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/appendix', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:appendix')
    registeOrgan(new Organ('kubejs:kidney_iron').addScore('filtration', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/kidney', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:kidney')
    registeOrgan(new Organ('kubejs:liver_iron').addScore('detoxification', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/liver', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:liver')
    registeOrgan(new Organ('kubejs:rib_iron').addScore('defense', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/rib', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:rib')
    registeOrgan(new Organ('kubejs:intestine_iron').addScore('nutrition', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/intestine', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:intestine')
    registeOrgan(new Organ('kubejs:lung_iron').addScore('breath_recovery', 1.25).addScore('breath_capacity', 1.25).addScore('endurance', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/lung', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:lung')
    registeOrgan(new Organ('kubejs:stomach_iron').addScore('digestion', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/stomach', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:stomach')
    registeOrgan(new Organ('kubejs:heart_iron').addScore('health', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/heart', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:heart')
    registeOrgan(new Organ('kubejs:spine_iron').addScore('defense', 0.625).addScore('nerves', 1.25).build()).modelJson(modelOverlay('kubejs:item/organs/common/spine', IRON_OVERLAY)).tag('kubejs:evolution').tag('kubejs:spine')
    registeOrgan(new Organ('kubejs:muscle_gold').addScore('strength', 1.5).addScore('speed', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/muscle', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:muscle')
    registeOrgan(new Organ('kubejs:spleen_gold').addScore('metabolism', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/spleen', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:spleen')
    registeOrgan(new Organ('kubejs:appendix_gold').addScore('luck', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/appendix', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:appendix')
    registeOrgan(new Organ('kubejs:kidney_gold').addScore('filtration', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/kidney', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:kidney')
    registeOrgan(new Organ('kubejs:liver_gold').addScore('detoxification', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/liver', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:liver')
    registeOrgan(new Organ('kubejs:rib_gold').addScore('defense', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/rib', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:rib')
    registeOrgan(new Organ('kubejs:intestine_gold').addScore('nutrition', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/intestine', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:intestine')
    registeOrgan(new Organ('kubejs:lung_gold').addScore('breath_recovery', 1.5).addScore('breath_capacity', 1.5).addScore('endurance', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/lung', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:lung')
    registeOrgan(new Organ('kubejs:stomach_gold').addScore('digestion', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/stomach', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:stomach')
    registeOrgan(new Organ('kubejs:heart_gold').addScore('health', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/heart', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:heart')
    registeOrgan(new Organ('kubejs:spine_gold').addScore('defense', 0.75).addScore('nerves', 1.5).build()).modelJson(modelOverlay('kubejs:item/organs/common/spine', GOLD_OVERLAY)).tag('kubejs:evolution').tag('kubejs:spine')
    registeOrgan(new Organ('kubejs:muscle_diamond').addScore('strength', 2).addScore('speed', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/muscle', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:muscle')
    registeOrgan(new Organ('kubejs:spleen_diamond').addScore('metabolism', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/spleen', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:spleen')
    registeOrgan(new Organ('kubejs:appendix_diamond').addScore('luck', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/appendix', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:appendix')
    registeOrgan(new Organ('kubejs:kidney_diamond').addScore('filtration', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/kidney', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:kidney')
    registeOrgan(new Organ('kubejs:liver_diamond').addScore('detoxification', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/liver', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:liver')
    registeOrgan(new Organ('kubejs:rib_diamond').addScore('defense', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/rib', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:rib')
    registeOrgan(new Organ('kubejs:intestine_diamond').addScore('nutrition', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/intestine', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:intestine')
    registeOrgan(new Organ('kubejs:lung_diamond').addScore('breath_recovery', 2).addScore('breath_capacity', 2).addScore('endurance', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/lung', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:lung')
    registeOrgan(new Organ('kubejs:stomach_diamond').addScore('digestion', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/stomach', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:stomach')
    registeOrgan(new Organ('kubejs:heart_diamond').addScore('health', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/heart', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:heart')
    registeOrgan(new Organ('kubejs:spine_diamond').addScore('defense', 1).addScore('nerves', 2).build()).modelJson(modelOverlay('kubejs:item/organs/common/spine', DIAMOND_OVERLAY)).tag('kubejs:evolution').tag('kubejs:spine')
});