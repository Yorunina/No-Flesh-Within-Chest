...
const organCharmNbtMap = {
    ...
    'kubejs:lung_template': { type: 'kill', killTask: { mobType: 'minecraft:zombie', killAmount: 3, counter: 0 }, targetOrgan: 'kubejs:lung_iron' },
    'kubejs:lung_iron': { type: 'kill', killTask: { mobType: 'minecraft:zombie', killAmount: 10, counter: 0 }, targetOrgan: 'kubejs:lung_gold' },
    'kubejs:lung_gold': { type: 'kill', killTask: { mobType: 'minecraft:zombie', killAmount: 30, counter: 0 }, targetOrgan: 'kubejs:lung_diamond' },

    'kubejs:spine_template': { type: 'kill', killTask: { mobType: 'minecraft:zombie', killAmount: 3, counter: 0 }, targetOrgan: 'kubejs:spine_iron' },
    'kubejs:spine_iron': { type: 'kill', killTask: { mobType: 'minecraft:zombie', killAmount: 10, counter: 0 }, targetOrgan: 'kubejs:spine_gold' },
    'kubejs:spine_gold': { type: 'kill', killTask: { mobType: 'minecraft:zombie', killAmount: 30, counter: 0 }, targetOrgan: 'kubejs:spine_diamond' },
    ...
    'kubejs:stomach_diamond': { type: 'diet', dietTask: { minHunger: 1, foodTypeAmount: 66, foodTypeList: [] }, targetOrgan: 'kubejs:greedy_stomach' },
