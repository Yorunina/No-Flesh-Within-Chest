ServerEvents.tags('worldgen/structure', event => {
  ...
  event.add('kubejs:graveyard', [
    ...
    'graveyard_biomes:mushroom_structure'
  ])
})

ServerEvents.tags('item', event => {
  event.add('kubejs:rain_ritual', [
    'minecraft:apple',
  ...
  event.add('kubejs:isb_spell_book', [
  ...
  event.add('kubejs:lung', [
    'chestcavity:lung',
    'chestcavity:rotten_lung',
    'chestcavity:animal_lung',
    'chestcavity:small_animal_lung',
    'chestcavity:insect_lung',
    'chestcavity:ender_lung',
    'chestcavity:dragon_lung',
    'chestcavity:llama_lung',
    'chestcavity:fireproof_lung',
    'chestcavity:saltwater_lung',
    'chestcavity:gas_bladder'
  ])
  ...
  event.add('kubejs:is_cookie_block', [
  ...
  event.add('biomancy:cannot_be_eaten_by_cradle', [
