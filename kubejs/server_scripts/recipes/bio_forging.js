...
ServerEvents.highPriorityData(event => {
    ...
    registerCustomRecipe(new BioForgingRecipe([{ 'count': 1, 'item': 'minecraft:spider_eye' }, { 'count': 1, 'item': 'meetyourfight:phantoplasm' }, { 'count': 6, 'item': 'biomancy:exotic_compound' }], Item.of('kubejs:holy_eyeball')).setNutrientsCost(60).setTab('biomancy:weapons'))
